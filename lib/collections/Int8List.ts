...
export namespace Int8List{
    /**
     * Read-only base class for a list of `number` values, backed by a `Int8Array`.
    ...
    export class R{
         ...
         * @returns The string tag "Int8List.R".
         */
        get [Symbol.toStringTag](): string { return "Int8List.R"; }
        ...
        /**
         * Returns the internal `Int8Array` containing the list's values.
         * @warning Direct modification of the returned array may corrupt the list's state and should be avoided.
         * @returns The internal `Int8Array`.
         */
        public array(): Int8Array { return this.values; }
         ...
         * @returns The length of the internal `Int8Array`.
         */
         ...
         * @param dst - Destination `Int8Array` or `null` to create a new array of size `len`.
         ...
         * @example
         * const list = new Int8List.RW(0).append(1n).append(2n);
         * const arr = list.toArray(0, 2, null); // Returns Int8Array [1n, 2n]
         */
        public toArray( index: number, len: number, dst: Int8Array | null ): Int8Array | null { return this.values.slice( 0, this._size ); }
         ...
         * @param dst - Destination `Int8Array`.
         ...
         */
        public getRange( dst: Int8Array, dstIndex: number, srcIndex: number, len: number ): number{
        ...
        public clone(): R{
            ...
            cloned.values = new Int8Array( this.values );
    ...
    /**
     * An empty, constant `Int8Array` used to avoid allocations for empty lists.
     * @private
     */
    ...
    export class RW extends R{
        /**
         * Tag for identifying the class in string representation.
         * @returns The string tag "Int8List.RW".
         */
        get [Symbol.toStringTag](): string { return "Int8List.RW"; }
         ...
         * @example
         * const emptyList = new Int8List.RW(10); // Capacity of 10
         * const filledList = new Int8List.RW(0, 5); // Size 5, filled with 0
         */
        constructor( lengthOrDefaultValue: number | number, size?: number ){
            if( typeof lengthOrDefaultValue === "number" ){
                ...
                this.values = lengthOrDefaultValue > 0 ?
                              new Int8Array( lengthOrDefaultValue ) :
                              O;
            }else{
        ...
        public add1( index: number, value: number ): RW{
            ...
            this.size = resize( this.values, this.values.length <= max ?
                                             ( this.values = new Int8Array( max + Math.floor( max / 2 ) ) ) :
         ...
         * @returns This instance for method chaining.
         * @example
         * const list = new Int8List.RW(0).add(1n, 2n, 3n);
         ...
         * @example
         * const list = new Int8List.RW(0).append(1n);
         * list.set1(0, 10);
         ...
         * @returns The number of elements removed.
         * @example
         * const list = new Int8List.RW(0).add(1n, 2n, 1n);
         ...
         * @example
         * const list = new Int8List.RW(0).add(1n, 2n);
         ...
         * @example
         * const list = new Int8List.RW(0).add(3n, 1n, 2n);
         * list.sortValues();
         * console.log(list.toJSON()); // ["1", "2", "3"]
         */
