...
export namespace Float64List{
    /**
     * Read-only base class for a list of `number` values, backed by a `Float64Array`.
    ...
    export class R{
         ...
         * @returns The string tag "Float64List.R".
         */
        get [Symbol.toStringTag](): string { return "Float64List.R"; }
         ...
         * @example
         * const list = new Float64List.R(0);
         */
        ...
        /**
         * Returns the internal `Float64Array` containing the list's values.
         * @warning Direct modification of the returned array may corrupt the list's state and should be avoided.
         * @returns The internal `Float64Array`.
         */
        public array(): Float64Array { return this.values; }
         ...
         * @returns The length of the internal `Float64Array`.
         */
         ...
         * @param dst - Destination `Float64Array` or `null` to create a new array of size `len`.
         ...
         * @example
         * const list = new Float64List.RW(0).append(1n).append(2n);
         * const arr = list.toArray(0, 2, null); // Returns Float64Array [1n, 2n]
         */
        public toArray( index: number, len: number, dst: Float64Array | null ): Float64Array | null { return this.values.slice( 0, this._size ); }
         ...
         * @param dst - Destination `Float64Array`.
         ...
         */
        public getRange( dst: Float64Array, dstIndex: number, srcIndex: number, len: number ): number{
        ...
        public clone(): R{
            ...
            cloned.values = new Float64Array( this.values );
    ...
    /**
     * An empty, constant `Float64Array` used to avoid allocations for empty lists.
     * @private
     */
    const O = new Float64Array( 0 );
    ...
    export class RW extends R{
        /**
         * Tag for identifying the class in string representation.
         * @returns The string tag "Float64List.RW".
         */
        get [Symbol.toStringTag](): string { return "Float64List.RW"; }
         ...
         * @example
         * const emptyList = new Float64List.RW(10); // Capacity of 10
         * const filledList = new Float64List.RW(0, 5); // Size 5, filled with 0
         */
        constructor( lengthOrDefaultValue: number | number, size?: number ){
            if( typeof lengthOrDefaultValue === "number" ){
                ...
                this.values = lengthOrDefaultValue > 0 ?
                              new Float64Array( lengthOrDefaultValue ) :
                              O;
            }else{
        ...
        public add1( index: number, value: number ): RW{
            ...
            this.size = resize( this.values, this.values.length <= max ?
                                             ( this.values = new Float64Array( max + Math.floor( max / 2 ) ) ) :
         ...
         * @returns This instance for method chaining.
         * @example
         * const list = new Float64List.RW(0).add(1n, 2n, 3n);
         ...
         * @example
         * const list = new Float64List.RW(0).append(1n);
         * list.set1(0, 10);
         ...
         * @returns The number of elements removed.
         * @example
         * const list = new Float64List.RW(0).add(1n, 2n, 1n);
         ...
         * @example
         * const list = new Float64List.RW(0).add(1n, 2n);
         ...
         * @example
         * const list = new Float64List.RW(0).add(3n, 1n, 2n);
         * list.sortValues();
         * console.log(list.toJSON()); // ["1", "2", "3"]
         */
