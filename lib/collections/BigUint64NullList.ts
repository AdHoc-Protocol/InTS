...
/**
 * A specialized list for storing `bigint` values with support for an `UNDEFINED` state to represent
 ...
 * {@link BigUint64Array} to store non-`UNDEFINED` `bigint` values. The choice of storage strategy
 ...
 * @example
 * ```typescript
 * const list = new BigUint64NullList.RW(10, undefined); // Empty list with capacity 10
 ...
 * @namespace
 */
export namespace BigUint64NullList{
    /**
     * A read-only base class for a list of `bigint` values with support for `UNDEFINED` states.
     *
     * @remarks
     ...
     * non-`UNDEFINED` and a {@link BigUint64Array} to store `bigint` values, organized according
    ...
    export abstract class R<UNDEFINED = undefined>{
         ...
         * A `true` bit indicates a non-`UNDEFINED` `bigint` value; a `false` bit indicates an `UNDEFINED` state.
        ...
        /**
         * The array storing `bigint` values for non-`UNDEFINED` elements.
         *
         * @remarks
         ...
         * @protected
         */
        protected values!: BigUint64Array;
         ...
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(1n).append(undefined);
         ...
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(undefined).append(1n);
         ...
         * @returns The `bigint` value if non-`UNDEFINED`, or `undefinedValue` if `UNDEFINED`.
         ...
         */
        public get( index: number ): bigint | UNDEFINED{
         ...
         *
         * @returns The `bigint` value if the last element is non-`UNDEFINED`, or `undefinedValue` if `UNDEFINED`.
         * @throws Error if the list is empty.
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(1n);
         * console.log(list.last); // 1n
         */
        get last(): bigint | UNDEFINED { return this.get( this.size - 1 ); }

        /**
         * Finds the first logical index of a specific `bigint` value.
         *
         * @param value The `bigint` value to search for.
         ...
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(1n).append(undefined).append(1n);
         * console.log(list.indexOf(1n)); // 0
         */
        public indexOf( value: bigint ): number{
        ...
        /**
         * Finds the last logical index of a specific `bigint` value.
         *
         * @param value The `bigint` value to search for.
         ...
         */
        public lastIndexOf( value: bigint ): number{
            if( this.isFlatStrategy ){
         ...
         *
         * @param value The `bigint` value or `undefinedValue` to search for.
         ...
         */
        public contains( value: bigint | UNDEFINED ): boolean { return value === this.undefinedValue ? this.nextNullIndex( -1 ) != -1 : this.indexOf( <bigint>value ) != -1; }
        ...
        static hash<UNDEFINED>( hash: number, src: R<UNDEFINED> | undefined ): number{
            ...
            const h = src.undefinedValue === undefined ? 17 : typeof src.undefinedValue === "bigint" ? AdHoc.hash_bigint( hash, src.undefinedValue ) : typeof src.undefinedValue === "number" ? AdHoc.hash_number( hash, src.undefinedValue ) : 37;

            for( let i = 0, size = src.size; i < size; i++ ) hash = AdHoc.mix( hash, src.hasValue( i ) ? AdHoc.hash_bigint( hash, <bigint>src.get( i ) ) : h );
         ...
         *
         * @returns The string "BigUint64ArrayNull.R".
         */
        get [Symbol.toStringTag](): string { return "BigUint64ArrayNull.R"; }
         ...
         *
         * @returns An array with `bigint` values for non-`UNDEFINED` elements and `undefinedValue` for `UNDEFINED` elements.
         * @example
         * const list = new BigUint64NullList.RW(0, null).append(1n).append(null);
         ...
         */
        public toArray( index: number, len: number, dst: ( bigint | UNDEFINED )[] ): ( bigint | UNDEFINED )[]{
            if( this.size === 0 ) return dst;
            if( dst === this.undefinedValue || dst.length < len ) dst = new Array<bigint | UNDEFINED>( len );
         ...
         * @example
         * const list1 = new BigUint64NullList.RW(0, undefined).append(1n).append(undefined);
         * const list2 = new BigUint64NullList.RW(0, undefined).append(1n);
         * console.log(list1.containsAll(list2)); // true
         */
        public containsAll( src: R ): boolean{
            for( let i = 0, s = src.size; i < s; i++ )
                if( src.hasValue( i ) ){
                    if( this.indexOf( <bigint>src.get( i ) ) === -1 ) return false;
         ...
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(1n).append(2n);
         * const found = list.findValue((v) => v === 2n); // 2n
         */
        findValue( predicate: ( value: bigint | UNDEFINED, index: number, list: R<UNDEFINED> ) => boolean ): bigint | UNDEFINED{
         ...
         */
        findValueIndex( predicate: ( value: bigint | UNDEFINED, index: number, list: R<UNDEFINED> ) => boolean ): number{
         ...
         */
        forEach( callbackfn: ( value: bigint | UNDEFINED, index: number, list: R<UNDEFINED> ) => void, thisArg?: any ): void{
            for( let i = 0; i < this.size; i++ ) callbackfn.call( thisArg, this.get( i ), i, this );
        }

        /**
         * Calculates the sum of all non-`UNDEFINED` `bigint` values.
         *
         * @returns The sum of non-`UNDEFINED` values, or `0n` if none exist.
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(1n).append(undefined).append(2n);
        ...
        sum(): bigint{
            ...
            for( let i = 0; i < this.size; i++ ){
                ...
                if( value !== this.undefinedValue ) totalSum += value as bigint;
            }
            return totalSum;
        }

        /**
         * Finds the minimum non-`UNDEFINED` `bigint` value.
         *
         * @returns The smallest non-`UNDEFINED` value, or `undefinedValue` if none exist.
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(2n).append(undefined).append(1n);
         * console.log(list.min()); // 1n
         */
        min(): bigint | UNDEFINED{
            let minValue: bigint | UNDEFINED = this.undefinedValue;
            for( let i = 0; i < this.size; i++ ){
                const value = this.get( i );
                if( value !== this.undefinedValue )
                    if( minValue === this.undefinedValue || ( value as bigint ) < ( minValue as bigint ) )
                        minValue = value;
            }
            return minValue;
        }
        ...
        /**
         * Finds the maximum non-`UNDEFINED` `bigint` value.
         *
        ...
        max(): bigint | UNDEFINED{
            let maxValue: bigint | UNDEFINED = this.undefinedValue;
            for( let i = 0; i < this.size; i++ ){
                const value = this.get( i );
                if( value !== this.undefinedValue )
                    if( maxValue === this.undefinedValue || ( value as bigint ) > ( maxValue as bigint ) )
                        maxValue = value;
            }
            return maxValue;
        }
         ...
         *
         * @returns An iterator yielding `bigint` values for non-`UNDEFINED` elements and JavaScript `undefined` for `UNDEFINED` elements.
        ...
        [Symbol.iterator](): IterableIterator<bigint | undefined>{
            let index = 0;
            return {
                next: (): IteratorResult<bigint | undefined> => {
    ...
    /**
     * A read-write implementation of a list supporting `bigint` values and `UNDEFINED` states.
     *
     * @remarks
    ...
    export class RW<UNDEFINED = undefined> extends R<UNDEFINED>{
         ...
         * Gets the string tag for the list.
         *
         * @returns The string "BigUint64ArrayNull.RW".
         */
        get [Symbol.toStringTag](): string { return "BigUint64ArrayNull.RW"; }
         ...
         * @example
         * const list = new BigUint64NullList.RW(10, undefined); // Empty list, capacity 10
         * const listFromArray = new BigUint64NullList.RW([1n, undefined, 2n], undefined);
         * console.log(listFromArray.toJSON()); // [1, undefined, 2]
         */
        constructor( lengthOrArray: number | ArrayLike<bigint | UNDEFINED>, undefinedValue: UNDEFINED = undefined as UNDEFINED, size?: number ){
            super( undefinedValue );
            if( typeof lengthOrArray === "number" ){
                this.nulls = size ? new BitList.RW( false, size ) : new BitList.RW( lengthOrArray );
                this.values = new BigUint64Array( lengthOrArray );
            }else{
                this.nulls = new BitList.RW( lengthOrArray.length );
                this.values = new BigUint64Array( lengthOrArray.length );
         ...
         * @param value The `bigint` or `undefinedValue` to set.
         * @throws Error if `index` is negative.
         * @protected
         */
        protected set_$( index: number, value: bigint | UNDEFINED ): void{
            if( index < 0 ) throw new Error( "Index cannot be negative" );
            if( value === this.undefinedValue ){
            ...
            if( this.isFlatStrategy ){
                ...
                this.values[this.nulls.rank( index ) - 1] = <bigint>value;
            }else{
                ...
                if( this.values.length <= max && this._flatStrategyThreshold <= this._cardinality ){
                    ...
                    this._cardinality = resize( this.values, this.values.length <= max ? ( this.values = new BigUint64Array( 2 + ( max * 3 ) / 2 ) ) : this.values, rank, this._cardinality, 1 );
                    this.values[rank] = <bigint>value;
                    this.nulls.set1( index );
                }
            }
        }
         ...
         * console.log(list.toJSON()); // [2]
         */
        public setLast( value: bigint | UNDEFINED ): RW<UNDEFINED>{
            this.set_$( Math.max( 0, this.size - 1 ), value );
            return this;
        }

        /**
         * Sets multiple elements from a list of `bigint` values.
         *
         * @param index The 0-based logical starting index.
         * @param values The `bigint` values to set (non-`UNDEFINED`).
         * @returns This instance for method chaining.
         * @throws Error if `index` is negative.
         * @remarks Extends the list with `UNDEFINED` elements if needed.
         * @example
         * const list = new BigUint64NullList.RW(0, undefined);
         * list.set(0, 1n, 2n);
         * console.log(list.toJSON()); // [1, 2]
         */
        public set( index: number, ...values: bigint[] ): RW<UNDEFINED> { return this.set__( index, values, 0, values.length ); }

        /**
         * Sets elements from an array-like object containing `bigint` or `UNDEFINED` values.
         *
         * @param index The 0-based logical starting index.
         ...
         * console.log(list.toJSON()); // [1, undefined, 2]
         */
        public set$( index: number, values: ArrayLike<bigint | UNDEFINED> ): RW<UNDEFINED>{
            for( let i = values.length; -1 < --i; ) this.set_$( index + i, values[i] );
            return this;
        }

        /**
         * Sets a range of elements from a `bigint` array.
         *
         * @param index The 0-based logical starting index.
         * @param src The source `bigint` array.
         ...
         */
        public set__( index: number, src: bigint[], src_index: number = 0, len: number = src.length ): RW<UNDEFINED>{
            if( index < 0 ) throw new Error( "Index cannot be negative" );
        ...
        /**
         * Sets a range of elements from an array containing `bigint` or `UNDEFINED` values.
         *
         * @param index The 0-based logical starting index.
         ...
         */
        public set$$( index: number, src: ( bigint | UNDEFINED )[], src_index: number, len: number ): RW<UNDEFINED>{
            if( index < 0 ) throw new Error( "Index cannot be negative" );
            if( src_index < 0 ) throw new Error( "Source index cannot be negative" );
            if( len < 0 ) throw new Error( "Length cannot be negative" );
            if( !src ) throw new Error( "Source array cannot be UNDEFINED" );
         ...
         *
         * @param items The array of `bigint` or `UNDEFINED` values to append.
         * @returns This instance for method chaining.
         ...
         * console.log(list.toJSON()); // [1, undefined, 2]
         */
        public add( items: ( bigint | UNDEFINED )[] ): RW<UNDEFINED> { return this.set$( this.size, items ); }

        /**
         * Appends a single element to the end of the list.
         *
         * @param value The `bigint` or `undefinedValue` to append.
         * @returns This instance for method chaining.
         ...
         * console.log(list.toJSON()); // [1, undefined]
         */
        public append( value: bigint | UNDEFINED ): RW<UNDEFINED>{
         ...
         * @param value The `bigint` or `undefinedValue` to insert.
         * @returns This instance for method chaining.
         * @throws Error if `index` is negative.
         * @remarks Shifts elements right and may extend the list with `UNDEFINED` elements.
         * @example
         * const list = new BigUint64NullList.RW(0, undefined).append(2n);
         * list.add1(0, 1n);
         * console.log(list.toJSON()); // [1, 2]
         */
        public add1( index: number, value: bigint | UNDEFINED ): RW<UNDEFINED>{
            if( value === this.undefinedValue ){
                const s = this.size;
                this.nulls.add$( index, false );
                if( this.isFlatStrategy ) resize( this.values, this.values.length <= this.nulls.size - 1 ? ( this.values = new BigUint64Array( ( ( this.nulls.size - 1 ) * 2 ) / 3 ) ) : this.values, index, s, 1 );
                return this;
            }
            if( index < 0 ) throw new Error( "Index cannot be negative" );
            if( index < this.size ){
                if( this.isFlatStrategy ){
                    ...
                    resize( this.values, this.values.length <= this.nulls.size - 1 ? ( this.values = new BigUint64Array( ( this.nulls.size * 3 ) / 2 ) ) : this.values, index, this.size - 1, 1 );
                    this.values[index] = <bigint>value;
                }else{
                    this.nulls.add$( index, true );
                    this._cardinality++;
                    ...
                    resize( this.values, this.values.length <= this._cardinality ? ( this.values = new BigUint64Array( ( this._cardinality * 3 ) / 2 ) ) : this.values, rank, this._cardinality - 1, 1 );
                    this.values[rank] = <bigint>value;
                }
         ...
         * @example
         * const list1 = new BigUint64NullList.RW(0, undefined).append(1n);
         * const list2 = new BigUint64NullList.RW(0, undefined).append(2n);
         * list1.addAll(list2);
         * console.log(list1.toJSON()); // [1, 2]
         */
        public addAll( src: R ): RW<UNDEFINED>{
            for( let i = 0, s = src.size; i < s; i++ )
                if( src.hasValue( i ) ) this.append( <bigint>src.get( i ) );
        ...
        public set length( length: number ){
            ...
            if( length === 0 ){
                this._cardinality = 0;
                this.values = new BigUint64Array();
                return;
            }
         ...
         * @example
         * const list = new BigUint64NullList.RW(10, undefined).append(1n);
         * list.fit();
        ...
        protected switchToFlatStrategy_( capacity: number ): void{
            if( this.size === 0 ){
                if( this.values.length === capacity ) this.values = new BigUint64Array( Math.max( 16, capacity ) );
            ...
            this.values = new BigUint64Array( capacity );
    ...
    /**
     * Creates a new `BigUint64Array` with the specified length, copying elements from the source.
     *
     * @param src The source `BigUint64Array`.
     * @param newLength The desired length of the new array.
     * @returns A new `BigUint64Array` with copied elements.
     * @private
     */
    function copyOf( src: BigUint64Array, newLength: number ): BigUint64Array{
        if( newLength == src.length ) return src;
        const ret = new BigUint64Array( newLength );
     ...
     *
     * @param src The source `BigUint64Array`.
     * @param dst The destination `BigUint64Array`.
     ...
     * @private
     */
    function resize( src: BigUint64Array, dst: BigUint64Array, index: number, size: number, resize: number ): number{
...
export default BigUint64NullList;