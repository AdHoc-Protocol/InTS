...
/**
 * Namespace for managing lists of 64-bit unsigned integers (`bigint`) with efficient read-only and read-write operations.
 * Provides methods for adding, removing, searching, iterating, and sorting large unsigned integers.
 * @namespace
 */
export namespace BigUint64List{
    /**
     * Read-only base class for a list of `bigint` values, backed by a `BigUint64Array`.
    ...
    export class R{
         ...
         * @returns The string tag "BigUint64List.R".
         */
        get [Symbol.toStringTag](): string { return "BigUint64List.R"; }

        /**
         * Sentinel value used for uninitialized elements when the list expands.
         * Must be a `bigint` that does not conflict with valid data in the use case.
         * @readonly
         */
        public readonly defaultValue: bigint;

        /**
         * Internal array storing the list's `bigint` values, dynamically resized as needed.
         * @protected
         */
         ...
         * @param defaultValue - The `bigint` value used for uninitialized elements.
         * @example
         * const list = new BigUint64List.R(0n);
         */
        ...
        /**
         * Returns the internal `BigUint64Array` containing the list's values.
         * @warning Direct modification of the returned array may corrupt the list's state and should be avoided.
         * @returns The internal `BigUint64Array`.
         */
        public array(): BigUint64Array { return this.values; }
         ...
         * @returns The length of the internal `BigUint64Array`.
         */
        ...
        /**
         * Checks if the list contains a specific `bigint` value.
         * @param value - The `bigint` value to search for.
         * @returns `true` if the value is found, `false` otherwise.
         */
        public contains( value: bigint ): boolean { return this.indexOf( value ) !== -1; }
         ...
         * @param dst - Destination `BigUint64Array` or `null` to create a new array of size `len`.
         ...
         * @example
         * const list = new BigUint64List.RW(0n).append(1n).append(2n);
         * const arr = list.toArray(0, 2, null); // Returns BigUint64Array [1n, 2n]
         */
        public toArray( index: number, len: number, dst: BigUint64Array | null ): BigUint64Array | null { return this.values.slice( 0, this._size ); }
         ...
         * @returns The `bigint` value at the end of the list.
         * @throws Error if the list is empty.
         */
        public get last(): bigint{
         ...
         * @param dst - Destination `BigUint64Array`.
         ...
         */
        public getRange( dst: BigUint64Array, dstIndex: number, srcIndex: number, len: number ): number{
         ...
         * @param value - The `bigint` value to locate.
         ...
         * @returns The 0-based index of the first occurrence, or -1 if not found.
         */
        public indexOfFrom( value: bigint, fromIndex: number = 0 ): number{
         ...
         * @returns `true` if the value is found, `false` otherwise.
         */
        public includesValue( value: bigint, fromIndex: number = 0 ): boolean { return this.indexOfFrom( value, fromIndex ) !== -1; }
         ...
         * // Outputs: 0: 1, 1: 2
         */
        public forEach( callbackfn: ( value: bigint, index: number, list: R ) => void, thisArg?: any ): void{
        ...
        static hash( hash: number, src: R | undefined ): number{
            return src ?
                   AdHoc.mix( hash, AdHoc.hash_array( hash, src.values, AdHoc.hash_bigint, src._size ) ) :
                   hash;
        }
        ...
        public clone(): R{
            ...
            cloned.values = new BigUint64Array( this.values );
        ...
        /**
         * Serializes the list to a JSON string, converting `bigint` values to strings.
         ...
         * @returns An iterator yielding `bigint` values from index 0 to `size - 1`.
         * @example
         * const list = new BigUint64List.RW(0n).append(1n).append(2n);
         * for (const value of list) console.log(value); // Outputs: 1, 2
         */
        public [Symbol.iterator](): IterableIterator<bigint> { return this.values.subarray( 0, this._size ).values(); }
    }

    /**
     * An empty, constant `BigUint64Array` used to avoid allocations for empty lists.
     * @private
     */
    const O = new BigUint64Array( 0 );

    /**
     * Read-write extension of `R`, adding methods to modify the list of `bigint` values.
     */
    export class RW extends R{
        /**
         * Tag for identifying the class in string representation.
         * @returns The string tag "BigUint64List.RW".
         */
        get [Symbol.toStringTag](): string { return "BigUint64List.RW"; }

        /**
         * Creates an empty list with a specified initial capacity or a list with initialized elements.
         * @param lengthOrDefaultValue - If a number, the initial capacity; if a `bigint`, the default value for uninitialized elements.
         * @param size - If provided, the initial size (if positive) or capacity (if negative, using absolute value).
         * @example
         * const emptyList = new BigUint64List.RW(10); // Capacity of 10
         * const filledList = new BigUint64List.RW(0n, 5); // Size 5, filled with 0n
         */
        constructor( lengthOrDefaultValue: number | bigint, size?: number ){
            if( typeof lengthOrDefaultValue === "number" ){
                super( 0n );
                this.values = lengthOrDefaultValue > 0 ?
                              new BigUint64Array( lengthOrDefaultValue ) :
                              O;
            }else{
                ...
                this.values = sizeVal === 0 ?
                              O :
                              new BigUint64Array( sizeVal < 0 ?
                                                  -sizeVal :
                                                  sizeVal );
                this._size = sizeVal < 0 ?
                             -sizeVal :
                             sizeVal;
                if( sizeVal > 0 && lengthOrDefaultValue !== 0n ) this.values.fill( lengthOrDefaultValue, 0, this._size );
            }
        }

        /**
         * Appends a `bigint` value to the end of the list, resizing if necessary.
         * @param value - The `bigint` value to append.
         * @returns This instance for method chaining.
         * @example
         * const list = new BigUint64List.RW(0n).append(1n).append(2n);
         * console.log(list.toJSON()); // ["1", "2"]
         */
        public append( value: bigint ): RW { return this.add1( this._size, value ); }

        /**
         * Inserts a `bigint` value at the specified index, shifting elements rightward.
         * @param index - The 0-based index for insertion.
         * @param value - The `bigint` value to insert.
         * @returns This instance for method chaining.
         * @throws Error if `index` is negative or exceeds `size + 1`.
         */
        public add1( index: number, value: bigint ): RW{
            const max: number = Math.max( index, this.size + 1 );
            this.size = resize( this.values, this.values.length <= max ?
                                             ( this.values = new BigUint64Array( max + Math.floor( max / 2 ) ) ) :
        ...
        /**
         * Appends multiple `bigint` values to the end of the list.
         * @param src - The `bigint` values to append.
         * @returns This instance for method chaining.
         * @example
         * const list = new BigUint64List.RW(0n).add(1n, 2n, 3n);
         * console.log(list.toJSON()); // ["1", "2", "3"]
         */
        public add( ...src: bigint[] ): RW { return this.addAt( this._size, src, 0, src.length ); }

        /**
         * Inserts a range of `bigint` values from an array at a specified index.
         * @param index - The 0-based index in this list to insert at.
         * @param src - Source array of `bigint` values.
         ...
         */
        public addAt( index: number, src: bigint[], srcIndex: number, len: number ): RW{
         ...
         * @returns This instance for method chaining.
         */
        public setLast( value: bigint ): RW { return this.set1( Math.max( 0, this.size - 1 ), value ); }
         ...
         * @example
         * const list = new BigUint64List.RW(0n).append(1n);
         * list.set1(0, 10n);
         * console.log(list.toJSON()); // ["10"]
         */
        public set1( index: number, value: bigint ): RW{
            ...
            if( index >= this._size ){
                if( this.defaultValue !== 0n ) this.values.fill( this.defaultValue, this._size, index );
                this._size = index + 1;
            }
            this.values[index] = value;
            return this;
        ...
        /**
         * Sets multiple `bigint` values starting at a specified index.
         * @param index - The 0-based index to start setting values.
         * @param src - The `bigint` values to set.
         * @returns This instance for method chaining.
         */
        public set( index: number, ...src: bigint[] ): RW { return this.setRange( index, src, 0, src.length ); }

        /**
         * Sets a range of `bigint` values from an array, expanding the list if necessary.
         ...
         * @throws Error if indices or length are invalid.
         */
        public setRange( index: number, src: bigint[], srcIndex: number, len: number ): RW{
        ...
        public removeAll( src: R ): number{
            ...
            const valuesToRemove = new Set<bigint>( src ); // Create a Set for efficient lookups
        ...
        /**
         * Removes all occurrences of a specific `bigint` value.
         * @param src - The `bigint` value to remove.
         * @returns The number of elements removed.
         * @example
         * const list = new BigUint64List.RW(0n).add(1n, 2n, 1n);
         * list.removeAllValue(1n);
         * console.log(list.toJSON()); // ["2"]
         */
        public removeAllValue( src: bigint ): number{
            const initialSize = this._size;
            let writeIndex = 0;
            for( let readIndex = 0; readIndex < this._size; readIndex++ )
        ...
        /**
         * Quickly removes all occurrences of a `bigint` value by replacing with the last element, possibly reordering the list.
         * @param valueToRemove - The `bigint` value to remove.
         * @returns This instance for method chaining.
         */
        removeAll_fast( valueToRemove: bigint ): RW{
            let i = 0;
            while( i < this._size )
         ...
         * @example
         * const list = new BigUint64List.RW(0n).add(1n, 2n);
         * const doubled = list.mapValue((v) => Number(v) * 2);
         * console.log(doubled); // [2, 4]
         */
        public mapValue<U>( callbackfn: ( value: bigint, index: number, list: RW ) => U, thisArg?: any ): U[]{
         ...
         * @example
         * const list = new BigUint64List.RW(0n).add(1n, 2n, 3n);
         * const evens = list.filter((v) => v % 2n === 0n);
         * console.log(evens.toJSON()); // ["2"]
         */
        public filter( predicate: ( value: bigint, index: number, list: RW ) => boolean, thisArg?: any ): RW{
         ...
         * @example
         * const list = new BigUint64List.RW(0n).add(3n, 1n, 2n);
         * list.sortValues();
         * console.log(list.toJSON()); // ["1", "2", "3"]
         */
        public sortValues( compareFn?: ( a: bigint, b: bigint ) => number ): RW{
            if( this._size > 1 )
