 ...
 * @namespace
 */
export namespace BigInt64List{
    /**
     * Read-only base class for a list of `bigint` values, backed by a `BigInt64Array`.
    ...
    export class R{
         ...
         * @returns The string tag "BigInt64List.R".
         */
        get [Symbol.toStringTag](): string { return "BigInt64List.R"; }
         ...
         * @example
         * const list = new BigInt64List.R(0n);
         */
        ...
        /**
         * Returns the internal `BigInt64Array` containing the list's values.
         * @warning Direct modification of the returned array may corrupt the list's state and should be avoided.
         * @returns The internal `BigInt64Array`.
         */
        public array(): BigInt64Array { return this.values; }
         ...
         * @returns The length of the internal `BigInt64Array`.
         */
         ...
         * @param dst - Destination `BigInt64Array` or `null` to create a new array of size `len`.
         ...
         * @example
         * const list = new BigInt64List.RW(0n).append(1n).append(2n);
         * const arr = list.toArray(0, 2, null); // Returns BigInt64Array [1n, 2n]
         */
        public toArray( index: number, len: number, dst: BigInt64Array | null ): BigInt64Array | null { return this.values.slice( 0, this._size ); }
         ...
         * @param dst - Destination `BigInt64Array`.
         ...
         */
        public getRange( dst: BigInt64Array, dstIndex: number, srcIndex: number, len: number ): number{
        ...
        public clone(): R{
            ...
            cloned.values = new BigInt64Array( this.values );
    ...
    /**
     * An empty, constant `BigInt64Array` used to avoid allocations for empty lists.
     * @private
     */
    const O = new BigInt64Array( 0 );
    ...
    export class RW extends R{
        /**
         * Tag for identifying the class in string representation.
         * @returns The string tag "BigInt64List.RW".
         */
        get [Symbol.toStringTag](): string { return "BigInt64List.RW"; }
         ...
         * @example
         * const emptyList = new BigInt64List.RW(10); // Capacity of 10
         * const filledList = new BigInt64List.RW(0n, 5); // Size 5, filled with 0n
         */
        constructor( lengthOrDefaultValue: number | bigint, size?: number ){
            if( typeof lengthOrDefaultValue === "number" ){
                ...
                this.values = lengthOrDefaultValue > 0 ?
                              new BigInt64Array( lengthOrDefaultValue ) :
                              O;
            }else{
        ...
        public add1( index: number, value: bigint ): RW{
            ...
            this.size = resize( this.values, this.values.length <= max ?
                                             ( this.values = new BigInt64Array( max + Math.floor( max / 2 ) ) ) :
         ...
         * @returns This instance for method chaining.
         * @example
         * const list = new BigInt64List.RW(0n).add(1n, 2n, 3n);
         ...
         * @example
         * const list = new BigInt64List.RW(0n).append(1n);
         * list.set1(0, 10n);
         ...
         * @returns The number of elements removed.
         * @example
         * const list = new BigInt64List.RW(0n).add(1n, 2n, 1n);
         ...
         * @example
         * const list = new BigInt64List.RW(0n).add(1n, 2n);
         ...
         * @example
         * const list = new BigInt64List.RW(0n).add(3n, 1n, 2n);
         * list.sortValues();
         * console.log(list.toJSON()); // ["1", "2", "3"]
         */
