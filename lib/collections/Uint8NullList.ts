 ...
 * {@link Uint8Array} to store non-`UNDEFINED` `number` values. The choice of storage strategy
 ...
 * @example
 * ```typescript
 * const list = new Uint8NullList.RW(10, undefined); // Empty list with capacity 10
 ...
 * @namespace
 */
export namespace Uint8NullList{
    /**
     ...
     * non-`UNDEFINED` and a {@link Uint8Array} to store `number` values, organized according
    ...
    export abstract class R<UNDEFINED = undefined>{
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(1n).append(undefined);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(undefined).append(1n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(1n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(1n).append(undefined).append(1n);
         ...
         *
         * @returns The string "Uint8ArrayNull.R".
         */
        get [Symbol.toStringTag](): string { return "Uint8ArrayNull.R"; }
         ...
         * @example
         * const list = new Uint8NullList.RW(0, null).append(1n).append(null);
         ...
         * @example
         * const list1 = new Uint8NullList.RW(0, undefined).append(1n).append(undefined);
         * const list2 = new Uint8NullList.RW(0, undefined).append(1n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(1n).append(2n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(1n).append(undefined).append(2n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(2n).append(undefined).append(1n);
    ...
    export class RW<UNDEFINED = undefined> extends R<UNDEFINED>{
         ...
         * Gets the string tag for the list.
         *
         * @returns The string "Uint8ArrayNull.RW".
         */
        get [Symbol.toStringTag](): string { return "Uint8ArrayNull.RW"; }
         ...
         * @example
         * const list = new Uint8NullList.RW(10, undefined); // Empty list, capacity 10
         * const listFromArray = new Uint8NullList.RW([1n, undefined, 2n], undefined);
        ...
        constructor( lengthOrArray: number | ArrayLike<number | UNDEFINED>, undefinedValue: UNDEFINED = undefined as UNDEFINED, size?: number ){
            ...
            if( typeof lengthOrArray === "number" ){
                ...
                this.values = new Uint8Array( lengthOrArray );
            }else{
                this.nulls = new BitList.RW( lengthOrArray.length );
                this.values = new Uint8Array( lengthOrArray.length );
        ...
        protected set_$( index: number, value: number | UNDEFINED ): void{
            ...
            if( this.isFlatStrategy ){
                ...
                if( this.values.length <= max && this._flatStrategyThreshold <= this._cardinality ){
                    ...
                    this._cardinality = resize( this.values, this.values.length <= max ? ( this.values = new Uint8Array( 2 + ( max * 3 ) / 2 ) ) : this.values, rank, this._cardinality, 1 );
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined);
         * list.set(0, 1n, 2n);
         ...
         * @example
         * const list = new Uint8NullList.RW(0, undefined).append(2n);
         * list.add1(0, 1n);
         * console.log(list.toJSON()); // [1, 2]
         */
        public add1( index: number, value: number | UNDEFINED ): RW<UNDEFINED>{
            if( value === this.undefinedValue ){
                ...
                if( this.isFlatStrategy ) resize( this.values, this.values.length <= this.nulls.size - 1 ? ( this.values = new Uint8Array( ( ( this.nulls.size - 1 ) * 2 ) / 3 ) ) : this.values, index, s, 1 );
                return this;
            }
            if( index < 0 ) throw new Error( "Index cannot be negative" );
            if( index < this.size ){
                if( this.isFlatStrategy ){
                    ...
                    resize( this.values, this.values.length <= this.nulls.size - 1 ? ( this.values = new Uint8Array( ( this.nulls.size * 3 ) / 2 ) ) : this.values, index, this.size - 1, 1 );
                    this.values[index] = <number>value;
                }else{
                    this.nulls.add$( index, true );
                    this._cardinality++;
                    ...
                    resize( this.values, this.values.length <= this._cardinality ? ( this.values = new Uint8Array( ( this._cardinality * 3 ) / 2 ) ) : this.values, rank, this._cardinality - 1, 1 );
                    this.values[rank] = <number>value;
                }
         ...
         * @example
         * const list1 = new Uint8NullList.RW(0, undefined).append(1n);
         * const list2 = new Uint8NullList.RW(0, undefined).append(2n);
         * list1.addAll(list2);
         ...
         * @example
         * const list = new Uint8NullList.RW(10, undefined).append(1n);
         * list.fit();
        ...
        protected switchToFlatStrategy_( capacity: number ): void{
            if( this.size === 0 ){
                if( this.values.length === capacity ) this.values = new Uint8Array( Math.max( 16, capacity ) );
    ...
    /**
     * Creates a new `Uint8Array` with the specified length, copying elements from the source.
     *
     * @param src The source `Uint8Array`.
     * @param newLength The desired length of the new array.
     * @returns A new `Uint8Array` with copied elements.
     * @private
     */
    function copyOf( src: Uint8Array, newLength: number ): Uint8Array{
     ...
     *
     * @param src The source `Uint8Array`.
     * @param dst The destination `Uint8Array`.
     ...
     * @private
     */
    function resize( src: Uint8Array, dst: Uint8Array, index: number, size: number, resize: number ): number{
