...
export namespace BigUint64ArrayNull {
    export abstract class R {
        ...
        get last(): bigint | undefined {return this.get(this.length - 1);}
        
        get(index: number): bigint | undefined {return this.nulls.get(index) ? this.values[this.nulls.rank(index) - 1] : undefined;}
        ...
        * [Symbol.iterator](): IterableIterator<bigint | undefined> {
        ...
        static hash(hash:number, src: R | undefined): number {
            return src ? AdHoc.mix(hash = BitList.R.hash(hash, src.nulls), AdHoc.hash_array(hash, src.values, AdHoc.hash_bigint, src.values_size)) : hash
        }
    }
    ...
    export class RW extends R {
        ...
        set capacity(items: number) {
            ...
            const tmp = new BigUint64Array(items);
        ...
        set last(value: bigint | undefined) { R.set(this, this.length - 1, value);}
...
export default BigUint64ArrayNull;
